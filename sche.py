...
class Task:
    def __init__(self, pTask=None, Delay=0, RunMe=0, *args, **kwargs):
        self.pTask = pTask
        self.Delay = Delay
        self.RunMe = RunMe
        self.args = args
...
def SCH_Add_Task(pFunction, DELAY, *args, **kwargs):
    global current_index_task
    if current_index_task < SCH_MAX_TASKS:
        SCH_tasks_G[current_index_task] = Task(pFunction, DELAY, 0, *args, **kwargs)
